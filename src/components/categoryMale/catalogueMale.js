...
import ProductData from '../productsMale.json'
...
class CatalogueMale extends Component {
    constructor(props){
        super(props)
        this.state = {
                                    ...
                                    <div class="col-sm-3">
                                        <div class="product2">
                                            ...
                                            <span style={{ display: "inline" }}>
                                                ...
                                                <button class="color" style={{ backgroundColor: productDetails.color2, visibility: productDetails.visible }}></button>
                                                <button class="color" style={{ backgroundColor: productDetails.color3, visibility: productDetails.visible }}></button>
                                            </span>
